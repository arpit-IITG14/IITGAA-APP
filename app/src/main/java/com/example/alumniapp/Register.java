            ...
            public void onClick(View v) {
                ...
                if (email.testValidity()) {
                    if (!branch_string.equals("") && !pass_string.isEmpty() && !phone_string.isEmpty() && !name_string.isEmpty() ) {
                        ...
                        if(year.getText().toString().length()==4 && Integer.parseInt(year.getText().toString())<= Calendar.getInstance().get(Calendar.YEAR)) {
                            ...
                            Snackbar.make(v, "Invalid Year", Snackbar.LENGTH_SHORT)
                                    .setAction("Action", null).show();
                        }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (error[0].equalsIgnoreCase("false")) {
                        ...
                        Snackbar.make(layout, "User Already Regisetered", Snackbar.LENGTH_SHORT).show();
                    }
